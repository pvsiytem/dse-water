...
num_features = 3 + encoder.transform([["Indonesia", "Urban"]]).shape[1]
...
st.markdown("---")
st.info("Now considers both country and area in predictions. Expand it further by adding more predictors!")
